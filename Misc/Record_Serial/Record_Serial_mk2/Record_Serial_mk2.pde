...
/*
Used by Following commands in prompt. 
It first waits a second for you to get into position, then you do your motion which it records.
Once you are done, press space and it stops the recording, checks the file for contents, then increments the file name. 
The prompt will then restart with waiting for a second then recording. 
To exit press x. 
